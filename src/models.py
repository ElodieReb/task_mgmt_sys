...
class Task(db.Model):
    ...
    assignees = db.relationship(
        ...
        secondary=assignees_table,
        back_populates='assigned_tasks',
        primaryjoin=id == assignees_table.c.task_id,
        secondaryjoin=id == assignees_table.c.user_id,
        lazy='select'
    )
...
class User(db.Model):
    ...
    assigned_tasks = db.relationship(
        ...
        secondary=assignees_table,
        back_populates='assignees',
        primaryjoin=id == assignees_table.c.user_id,
        secondaryjoin=(id == assignees_table.c.task_id) & (Task.id == assignees_table.c.task_id),
        lazy='select'
    )
